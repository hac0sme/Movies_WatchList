...
def index():
    ...
    return render_template("index.html",title="Movies Watchlist", movies_data= movies, user_data= user)
...
@pages.route("/logout")
def logout():
    #del session["user_id"] -> para borrar ciertas cosas si se necesita y dejar otras
